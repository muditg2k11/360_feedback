/*
  ...
  ### `scraping_jobs`
  Tracks automated scraping jobs for news collection
  - `id` (uuid, primary key)
  - `source_id` (uuid, foreign key to media_sources) - The media source being scraped
...
-- Add url field to feedback_items for tracking source URL
DO $$
BEGIN
  IF NOT EXISTS (
